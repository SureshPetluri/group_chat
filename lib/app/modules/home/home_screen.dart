...
class HomeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: homeState.users.isNotEmpty
                              ...
                              child: ListTile(
                                ...
                                leading: Stack(
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      onTap: () {
                                        ...
                                        homeNotifier.selectedUsers.add({
                                          "userId": user.userId,
                                          "docId": user.docId,
                                          "profileNmae": user.name,
                                          "isGroupAdmin":
                                              homeNotifier.getUserId() ==
                                                  user.userId,
                                    ...
                                    Visibility(
                                      visible: homeState.selectedItems[index] ==
                                          true,
          ...
          : const Center(
              child: Text(
              "present you don't have number in your community to create group.",
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    AppButton(
                      onPressed: () async {
                        await homeNotifier.createGroup(context, ref,
                            ref.watch(groupIdProvider.notifier).state);
                      },
                      title: "Create Group",
                      titleColor: Colors.black,
  ...
  void _showAlertDialog(BuildContext context) {
    showDialog(
      ...
      // Prevents dismissing by tapping outside the dialog
